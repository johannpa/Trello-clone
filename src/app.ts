...
function setContenairItems(btn: HTMLButtonElement){
    actualBtn = btn;
...
const addContainerFormInpput = document.querySelector('.add-new-container input') as HTMLInputElement;
...
function createNewContainer(e:Event) {
    e.preventDefault();
    if(addContainerFormInpput.value.length === 0) {
    ...
    const newContainerContent = `
        <div class="top-container">
          <h2>${addContainerFormInpput.value}</h2>
